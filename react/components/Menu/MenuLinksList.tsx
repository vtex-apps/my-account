...
function renderLinks(links: Link[], { showMyCards, showMyOrders, hideMyAuthentication }: RenderLinksOptions) {
  ...
  public render() {
    ...
    return (
      <nav className="vtex-account__menu-links">
        ...
        />
        {renderLinks(defaultLinks, { showMyCards, showMyOrders, hideMyAuthentication })}
        <ExtensionPoint
          id="menu-links-after"
          render={(links: Link[]) =>
            renderLinks(links, { showMyCards, showMyOrders, hideMyAuthentication })
