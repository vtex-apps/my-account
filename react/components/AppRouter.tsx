  ...
  public render() {
    const routes = [
      ...
      { path: '/profile', component: Profile },
      {
        path: '/profile/edit',
        component: () => (
          <ProfileEdit blockDocument={this.props.blockDocument} validateUniqueDocument={this.props.validateUniqueDocument} cleanMaskDocument={this.props.cleanMaskDocument} />
        ),
      },
    ]
